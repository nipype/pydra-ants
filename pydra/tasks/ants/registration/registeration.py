...
input_fields = [
    ...
    (
        ...
        ty.Any,
        {"help_string": ""},
    ),  # 5? how to specify this parameter relates to the other choice for output_transform_prefix
    (
    ...
    (
        ...
        ty.Any,
        {"help_string": ""},
    ),  # 10? add teh parameter for the selected interpolation later
    (
